package org.dimigo.oop.openapi;
...
public class NaverSearch {
    public static void main(String[] args) {
        String clientId = "SzWbI45XzEDsNfd4hHcN";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "hn_MMa44ba";//애플리케이션 클라이언트 시크릿값";
        try {
            String text = URLEncoder.encode("벤허", "UTF-8");
